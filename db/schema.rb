...
ActiveRecord::Schema.define(version: 20151020211013) do
  ...
  add_index "down_votes", ["user_id", "downable_id", "downable_type"], name: "index_down_votes_on_user_id_and_downable_id_and_downable_type", unique: true, using: :btree
